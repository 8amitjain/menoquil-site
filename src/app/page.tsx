...
/* âââââââââââââ Announcement Bar âââââââââââââ */
function AnnouncementBar() {
  const items = Array(12).fill('ð HOLIDAY SALE â UP TO $150 OFF');
  return (
    <div className="marquee bg-teal-accent">
      <div className="marquee-content py-[10px]">
        {items.map((text, i) => (
          <span
            key={i}
            className="marquee-item text-white text-[13px] font-semibold tracking-wide px-8"
          >
            {text}
          </span>
        ))}
    ...
    <header className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-[1400px] mx-auto flex items-center justify-between px-8 py-4">
        ...
        <a href="#" className="text-rose-primary font-serif text-[28px] font-bold tracking-tight leading-none">
          MENOQUIL<sup className="text-[10px] relative -top-3">â¢</sup>
        </a>

        {/* Nav Links */}
        <nav className="hidden md:flex items-center gap-10">
          {['Symptoms', 'Ingredients', 'Reviews', 'FAQ'].map((item) => (
            <a
              key={item}
              href={`#${item.toLowerCase()}`}
              className="text-dark-brown text-[15px] font-medium hover:text-rose-primary transition-colors"
            >
              {item}
            </a>
          ))}
        ...
        <div className="flex items-center gap-5">
          <a
            href="#"
            className="hidden md:flex items-center gap-2 text-dark-brown text-[15px] font-medium hover:text-rose-primary transition-colors"
          >
          ...
          <a
            href="#pricing"
            className="bg-rose-primary hover:bg-[#c4395f] text-white text-[14px] font-semibold px-6 py-2.5 rounded-full transition-all shadow-md hover:shadow-lg"
          >
            Order Now
          </a>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center gap-10 lg:gap-16">
          ...
          <div className="flex-1 max-w-[640px]">
            ...
            <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm border border-white/20 rounded-full px-5 py-2 mb-7">
              ...
              <span className="text-white text-[13px] font-medium tracking-wide">
                Non-Hormonal â¢ Clinically Studied Ingredients
              </span>
            </div>
            ...
            <h1 className="font-serif text-white text-[44px] md:text-[52px] leading-[1.12] font-bold mb-6">
              ...
              Balanced â <span className="italic text-teal-accent">Without</span>
              <br />
            ...
            <p className="text-white/80 text-[16px] md:text-[17px] leading-relaxed mb-7 max-w-[520px]">
              97% of women report significant relief from hot flashes, night
              sweats, and mood changes within 30 days. Science-backed.
              Doctor-recommended.
            </p>
            ...
            <ul className="space-y-3 mb-8">
              {[
                ...
                'Eases mood swings & irritability',
              ].map((item, i) => (
            ...
            <div className="flex flex-wrap items-center gap-4 mb-8">
              <a
                href="#pricing"
                className="bg-rose-primary hover:bg-[#c4395f] text-white text-[15px] font-semibold px-8 py-3.5 rounded-full transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5"
              >
                Try Risk-Free for 60 Days
              </a>
              <a
                href="#science"
                className="border-2 border-white/40 hover:border-white/70 text-white text-[15px] font-semibold px-8 py-3.5 rounded-full transition-all hover:bg-white/10"
              >
                See How It Works
              </a>
            </div>
          ...
          <div className="relative flex-shrink-0 hidden lg:block">
            ...
            <div className="absolute -top-4 -right-6 w-[120px] h-[120px]">
              <Image
                src="/images/doctor-badge.png"
                alt="Doctor Formulated Badge"
                width={120}
                height={120}
...
/* âââââââââââââ Comparison Section âââââââââââââ */
function Comparison() {
  const menoquilItems = [
    ...
    <section className="bg-cream-bg py-20 md:py-28">
      <div className="max-w-[1100px] mx-auto px-8">
        ...
        <h2 className="font-serif text-dark-brown text-[36px] md:text-[42px] font-bold text-center mb-5 leading-tight">
          &ldquo;Is This Basically Hormones?&rdquo;
        </h2>

        {/* Description */}
        <p className="text-text-muted text-[16px] md:text-[17px] leading-relaxed text-center max-w-[700px] mx-auto mb-14">
          No. Menoquil contains zero estrogen, progesterone, or any hormones.
          It&apos;s a plant-based formula safe for women who can&apos;t or won&apos;t take HRT.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-gradient-to-br from-[#e0faf5] to-[#ccf7ef] border-t-4 border-teal-accent rounded-[20px] p-8 md:p-10 shadow-sm">
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3 className="text-dark-brown text-[20px] font-bold tracking-tight">
                MENOQUIL<sup className="text-[9px]">â¢</sup>
              </h3>
            </div>

            <ul className="space-y-5">
              {menoquilItems.map((item, i) => (
          ...
          <div className="bg-[#f5f0ed] border-t-4 border-gray-300 rounded-[20px] p-8 md:p-10 shadow-sm">
            <div className="flex items-center gap-3 mb-7">
              ...
              <h3 className="text-text-muted text-[20px] font-bold tracking-tight">
                Hormone Therapy (HRT)
              </h3>
            </div>
        ...
        <p className="text-text-muted/70 text-[12px] leading-relaxed text-center max-w-[800px] mx-auto">
          <strong className="text-text-muted">Important:</strong> Menoquil is not a replacement for hormone therapy
          if prescribed by your doctor. Always consult your healthcare provider
          before starting any supplement, especially if you have a history of
          breast cancer or are taking other medications.
        </p>
      </div>
    </section>
  );
